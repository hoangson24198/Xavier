...
import com.hoangson.xavier.core.ui.titleTextStyle
...
@Composable
fun GradientText(name: String, size: Float = 130F, colors: List<Color> = plasmaGradient, modifier: Modifier = Modifier) {
